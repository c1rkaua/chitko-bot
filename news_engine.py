...
TRACKER_SKIP = [
    ...
    "заробіток у соцмереж", "заработок в соц",
    "заробити від", "заработать от",
    "перегляд відео", "лайки, коментарі",
    "відгуки на google", "отзывы на google",
    "аванс 4800", "аванс на карт",
    "графік вільний", "вкладень не потрібн",
    "писати в telegram", "пишите в telegram",
    "робота в інтернеті", "работа в интернете",
    "набір співробітник", "вакансія без досвіду",
]
