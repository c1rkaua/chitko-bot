...
CIVILIAN_KEYS = [
    ...
    "мобіліз", "мобилиз", "пожеж", "пожар", "загорян", "горить",
    "вибух газу", "взрыв газа", "обвал", "затопи", "затоп",
    "поранен", "ранен", "загинул", "погиб",
    ...
    "бориспіл", "вишгород", "дврз",
    "влучан", "уламк", "приліт", "прилет",
    "склад", "атб", "нової пошт", "нова пошт", "епіцентр",
...
HIT_PLACE = (
    ...
    "бориспіл", "бориспол", "оболон", "печерськ", "позняк", "дарниц",
    "одес", "харков", "дніпр", "львів", "запоріж", "миколаїв",
    "дніпровськ",
)
HIT_EVENT = (
    "склад", "пожеж", "пожар", "горить", "загорян",
    "приліт", "влучан", "уламк", "атак", "удар",
    "загибл", "загинул", "жертв", "поранен",
    "зруйнов", "багатоповерх", "депо", "залізниц",
)
HIT_BIZ = (
    "азс", "заправк", "банк", "відділен", "банкомат",
    "тц ", "трц", "торговельн", "супермаркет", "гіпермаркет",
    "аптек", "пошт", "логіст", "термінал",
    "атб", "сільпо", "фора", "укрзаліз", "залізниц", "депо",
